...
export const getIconCard = (brand, size) => {
  const value = brand === null || brand === void 0 ? void 0 : brand.toLowerCase();
...
export const getGoogleMapImage = ({
  lat,
  lng
}, apiKey) => {
