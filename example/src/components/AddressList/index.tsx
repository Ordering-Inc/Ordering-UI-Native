		...
		<Container nopadding={nopadding}>
			<AddressListContainer>
				...
				{!isFromProfile && addressList?.addresses?.length > 0 && (
					<OButton text={t('CONTINUE', 'Continue')} style={styles.button} onClick={() => onNavigationRedirect('BusinessesListing', {isFromBusinessList: true})} textStyle={{color: colors.white}} />
				)}
			</AddressListContainer>
		</Container>
	)
