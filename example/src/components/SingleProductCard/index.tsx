  ...
  return (
    <CardContainer
      ...
      <CardInfo>
        ...
        <OText size={12} weight={'400'} style={styles.line18} color={colors.textNormal}>
      ...
      {(isSoldOut || maxProductQuantity <= 0) && (
        <SoldOut>
          <OText size={12} weight="bold" color={colors.textSecondary} style={styles.soldOutTextStyle}>
            {t('SOLD_OUT', 'SOLD OUT')}
          </OText>
        </SoldOut>
      )}
