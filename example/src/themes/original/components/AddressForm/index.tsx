...
import { OInput, OButton, OText, OModal, OIcon } from '../../../../components/shared';
...
const tagsName = [
  ...
  { icon: images.general.tag_building, value: 'office' },
  { icon: images.general.tag_heart, value: 'favorite' },
  { icon: images.general.tag_plus, value: 'other' },
];
