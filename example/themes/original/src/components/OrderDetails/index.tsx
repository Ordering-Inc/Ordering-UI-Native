...
export const OrderDetailsUI = (props: OrderDetailsParams) => {
  ...
  const locations = [
    ...
    },
    {
      ...
      icon: order?.business?.logo || images.dummies.businessLogo,
    },
    {
        ...
        <>
          <Header>
            <OButton
              ...
              imgLeftStyle={{ tintColor: colors.disabled }}
            />
            <OrderInfo>
              <OrderData>
                <OText
                ...
                <OText size={12} lineHeight={18} color={colors.textNormal}>
                ...
                <StaturBar>
                  <LinearGradient
                    ...
                    colors={[colors.primary, colors.backgroundGray100]}
          ...
          <OrderContent>
				...
				{order?.driver && (
					...
					<OrderDriver>
						...
						<Customer>
							...
							<OText size={12} lineHeight={18} color={colors.textNormal} mBottom={2} style={{flexGrow: 1, flexBasis: '80%'}}>
							...
							<OText size={12} lineHeight={18} color={colors.textNormal} mBottom={2}>
            ...
            <HeaderInfo>
              ...
              <OText color={colors.textNormal} size={14} weight={'500'}>
                {t(
            ...
            <OrderBill>
					<View style={{height: 1, backgroundColor: colors.border, marginBottom: 17}} />
              <Table>
                <OText size={12} lineHeight={18} weight={'400'} color={colors.textNormal}>{t('SUBTOTAL', 'Subtotal')}</OText>
              ...
              {(order?.summary?.discount > 0 || order?.discount > 0) && (
                <Table>
                  {order?.offer_type === 1 ? (
                    <OText size={12} lineHeight={18} weight={'400'} color={colors.textNormal}>
                      {t('DISCOUNT', 'Discount')}
                      <OText size={12} lineHeight={18} weight={'400'} color={colors.textNormal}>{`(${verifyDecimals(
                        order?.offer_rate,
                        parsePrice,
                      )}%)`}</OText>
                    </OText>
                  ) : (
                    <OText size={12} lineHeight={18} weight={'400'} color={colors.textNormal}>{t('DISCOUNT', 'Discount')}</OText>
                  )}
                  <OText size={12} lineHeight={18} weight={'400'} color={colors.textNormal}>
              ...
              {(order?.summary?.delivery_price > 0 ||
                order?.deliveryFee > 0) && (
                <Table>
                  <OText size={12} lineHeight={18} weight={'400'} color={colors.textNormal}>{t('DELIVERY_FEE', 'Delivery Fee')}</OText>
                  <OText size={12} lineHeight={18} weight={'400'} color={colors.textNormal}>
                    {parsePrice(
              ...
              <Total>
                <Table>
                  <OText size={20} lineHeight={30} weight={'600'} color={colors.textNormal}>{t('TOTAL', 'Total')}</OText>
                  <OText size={20} lineHeight={30} weight={'600'} color={colors.textNormal}>
