...
const OButton = (props: Props): React.ReactElement => {
	...
	return (
		...
		>
			<StyledButton style={{ ...props.style, backgroundColor: props.bgColor ?? theme?.general?.components?.buttons?.color, borderColor: props.borderColor ?? theme?.general?.components?.buttons?.color, borderRadius: props.style?.borderRadius ?? parseInt(theme?.general?.components?.buttons?.borderRadius) }}>
				{props.icon ? (
