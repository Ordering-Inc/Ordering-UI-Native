  ...
  return (
    <>
      <OptionTitle>
        ...
        <OText size={16} color={theme.colors.textSecondary} mBottom={10} style={{ textAlign: 'left' }}>
          ...
          {activeOrders ? (
            <Placeholder style={{ marginTop: 30 }} Animation={Fade}>
              <View style={{ width: '100%' }}>
                <PlaceholderLine width={100} height={100} style={{ marginBottom: 10, borderRadius: 0 }} />
